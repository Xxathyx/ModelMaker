...
public class ModelsProgressPages {
	...
	public void pagesCreation() {
		  ...
		  File modelsFolder = new File(plugin.getDataFolder() + "/data/" + player.getUniqueId() + "/models progress/");
		  ...
		  for(int i = 0; i < pages; i++) {
			  Interface Interface = template.getModelsProgressInterface(player);
	...
	public void countPages() {
		...
		pages = (playerProfil.getModelsProgressCount() / 45) + 1;
	}
